 ...
 */
public class UndertowEncryptHttpHandler extends UndertowCommonHttpHandler {
    private  final Logger logger = LoggerUtils.getLogger(UndertowEncryptHttpHandler.class);
    private ILoginService loginService;
    private IAppInfoService appInfoService;

    public UndertowEncryptHttpHandler(String method, HandlerProxy apiInvocation, ILoginService loginService, IAppInfoService appInfoService) {
